...
Supports both sync (for autogenerate/offline) and async (for online migration)
execution against the same database URL used by the application.
"""
...
# Override sqlalchemy.url with the application's configured URL
